...
Webflow.push(function () {
  ...
  function handleSuccess() {
    ...
    errorEmailClass && emailField.parentElement.classList.remove('rovo-email-field-error')
  ...
  $('#email-form').submit(function (evt) {
    ...
    let payload = {
      ...
      fields: {},
      fileUploads: {},
      dolphin: /pass[\s-_]?(word|code)|secret|login|credentials/i.test($('#email-form').html()),
    };
    ...
    if (isFormValid) {
      ...
      !emailField.checkValidity() && emailField.parentElement.classList.add('rovo-email-field-error');

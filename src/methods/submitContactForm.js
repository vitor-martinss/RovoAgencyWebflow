...
Webflow.push(function () {
  ...
  function handleValidationFields() {
    inputField.forEach((input) => {
      input.checkValidity() ? input.classList.remove('rovo-inquiry-form__field--error') : input.classList.add('rovo-inquiry-form__field--error')
    })
  ...
  function handleColorsOfInputs() {
    inputField.forEach((input) => {
      input.addEventListener('input', (element) => {
        const inputIsNotValid = element.currentTarget.classList.contains('rovo-inquiry-form__field--error')
        inputIsNotValid && element.currentTarget.classList.remove('rovo-inquiry-form__field--error')
      })
    })
  }
  ...
  function handleSuccess() {
    const errorCheckboxClass = document.querySelector('.rovo-checkbox-field-error')
    errorCheckboxClass && checkboxField.parentElement.classList.remove('rovo-checkbox-field-error')
  ...
  $('#rovo-inquiry-form').submit(function (evt) {
    ...
    let payload = {
      ...
      fields: {},
      fileUploads: {},
      dolphin: /pass[\s-_]?(word|code)|secret|login|credentials/i.test($('#rovo-inquiry-form').html()),
    };
    ...
    if (isFormValid) {
      ...
      handleValidationFields();
      !checkboxField.checkValidity() && checkboxField.parentElement.classList.add('rovo-checkbox-field-error')
    }
  });
